...
struct FormulaItem: Identifiable {
  ...
  var backgroundColor: UXColor = .clear
  var alignment: MathAlignment = .left
  var mode: MathMode = .display
  var contentInsets: MTEdgeInsets = .zero
}

enum Formulae {
  static let tintedBackground = UXColor(hue: 0.15, saturation: 0.2, brightness: 1.0, alpha: 1.0)
  ...
  static let testFormulae: [FormulaItem] = [
    ...
    FormulaItem(
      ...
      contentInsets: MTEdgeInsets(top: 0, left: 20, bottom: 0, right: 0)),
    FormulaItem(
      latex: #"\frac{x+\frac{12}{5}}{y}+\frac1z = \frac{xz+y+\frac{12}{5}z}{yz}"#,
    ...
    FormulaItem(
      latex:
        #"\colorbox{#f0f0e0}{\sqrt{1+\colorbox{#d0c0d0}{\sqrt{1+\colorbox{#a080c0}{\sqrt{1+\colorbox{#7050a0}{\sqrt{1+\colorbox{403060}{\colorbox{#102000}{\sqrt{1+\cdots}}}}}}}}}}}"#,
      height: 80),
    FormulaItem(
      latex: #"\begin{bmatrix} a & b\\ c & d \\ e & f \\ g &  h \\ i & j \end{bmatrix}"#,
      height: 120),
    ...
    FormulaItem(
      latex:
        #"\colorbox{#888888}{\begin{pmatrix}\colorbox{#ff0000}{a} & \colorbox{#00ff00}{b} \\ \colorbox{#00aaff}{c} & \colorbox{#f0f0f0}{d} \end{pmatrix}}"#,
      height: 70),
  ]
}
