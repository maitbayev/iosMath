...
private let superScriptCases: [SuperScriptCase] = [
  SuperScriptCase(
    input: "x^2", mainTypes: [.variable], superTypes: [.number], nestedSuperTypes: nil,
    latex: "x^{2}"),
  SuperScriptCase(
    input: "x^23", mainTypes: [.variable, .number], superTypes: [.number], nestedSuperTypes: nil,
    latex: "x^{2}3"),
  SuperScriptCase(
    input: "x^{23}", mainTypes: [.variable], superTypes: [.number, .number], nestedSuperTypes: nil,
    latex: "x^{23}"),
  SuperScriptCase(
    input: "x^2^3", mainTypes: [.variable, .ordinary], superTypes: [.number], nestedSuperTypes: nil,
    latex: "x^{2}{}^{3}"),
  SuperScriptCase(
    input: "x^{2^3}", mainTypes: [.variable], superTypes: [.number], nestedSuperTypes: [.number],
    latex: "x^{2^{3}}"),
  SuperScriptCase(
    input: "x^{^2*}", mainTypes: [.variable], superTypes: [.ordinary, .binaryOperator],
    nestedSuperTypes: [.number], latex: "x^{{}^{2}*}"),
  SuperScriptCase(
    input: "^2", mainTypes: [.ordinary], superTypes: [.number], nestedSuperTypes: nil,
    latex: "{}^{2}"),
  SuperScriptCase(
    input: "{}^2", mainTypes: [.ordinary], superTypes: [.number], nestedSuperTypes: nil,
    latex: "{}^{2}"),
  SuperScriptCase(
    input: "x^^2", mainTypes: [.variable, .ordinary], superTypes: [], nestedSuperTypes: nil,
    latex: "x^{}{}^{2}"),
  SuperScriptCase(
    input: "5{x}^2", mainTypes: [.number, .variable], superTypes: [], nestedSuperTypes: nil,
    latex: "5x^{2}"),
]

private let subScriptCases: [SubScriptCase] = [
  SubScriptCase(
    input: "x_2", mainTypes: [.variable], subTypes: [.number], nestedSubTypes: nil, latex: "x_{2}"),
  SubScriptCase(
    input: "x_23", mainTypes: [.variable, .number], subTypes: [.number], nestedSubTypes: nil,
    latex: "x_{2}3"),
  SubScriptCase(
    input: "x_{23}", mainTypes: [.variable], subTypes: [.number, .number], nestedSubTypes: nil,
    latex: "x_{23}"),
  SubScriptCase(
    input: "x_2_3", mainTypes: [.variable, .ordinary], subTypes: [.number], nestedSubTypes: nil,
    latex: "x_{2}{}_{3}"),
  SubScriptCase(
    input: "x_{2_3}", mainTypes: [.variable], subTypes: [.number], nestedSubTypes: [.number],
    latex: "x_{2_{3}}"),
  SubScriptCase(
    input: "x_{_2*}", mainTypes: [.variable], subTypes: [.ordinary, .binaryOperator],
    nestedSubTypes: [.number], latex: "x_{{}_{2}*}"),
  SubScriptCase(
    input: "_2", mainTypes: [.ordinary], subTypes: [.number], nestedSubTypes: nil, latex: "{}_{2}"),
  SubScriptCase(
    input: "{}_2", mainTypes: [.ordinary], subTypes: [.number], nestedSubTypes: nil, latex: "{}_{2}"
  ),
  SubScriptCase(
    input: "x__2", mainTypes: [.variable, .ordinary], subTypes: [], nestedSubTypes: nil,
    latex: "x_{}{}_{2}"),
  SubScriptCase(
    input: "5{x}_2", mainTypes: [.number, .variable], subTypes: [], nestedSubTypes: nil,
    latex: "5x_{2}"),
]

private let superSubScriptCases: [SuperSubScriptCase] = [
  SuperSubScriptCase(
    input: "x_2^*", mainTypes: [.variable], subTypes: [.number], superTypes: [.binaryOperator],
    latex: "x^{*}_{2}"),
  SuperSubScriptCase(
    input: "x^*_2", mainTypes: [.variable], subTypes: [.number], superTypes: [.binaryOperator],
    latex: "x^{*}_{2}"),
  SuperSubScriptCase(
    input: "x_^*", mainTypes: [.variable], subTypes: [], superTypes: [.binaryOperator],
    latex: "x^{*}_{}"),
  SuperSubScriptCase(
    input: "x^_2", mainTypes: [.variable], subTypes: [.number], superTypes: [], latex: "x^{}_{2}"),
  SuperSubScriptCase(
    input: "x_{2^*}", mainTypes: [.variable], subTypes: [.number], superTypes: [],
    latex: "x_{2^{*}}"),
  SuperSubScriptCase(
    input: "x^{*_2}", mainTypes: [.variable], subTypes: [], superTypes: [.binaryOperator],
    latex: "x^{*_{2}}"),
  SuperSubScriptCase(
    input: "_2^*", mainTypes: [.ordinary], subTypes: [.number], superTypes: [.binaryOperator],
    latex: "{}^{*}_{2}"),
]
...
private let parseErrorCases: [ParseErrorCase] = [
  ...
  ParseErrorCase(
    input: "\\begin{displaylines} x & y \\end{displaylines}", error: .invalidNumColumns),
...
struct MathListBuilderTests {
  ...
  @Test func symbols() throws {
    ...
    #expect(superList.atoms[0].type == .number)
    #expect(superList.atoms[0].nucleus == "2")
    #expect(superList.atoms[1].type == .binaryOperator)
    #expect(superList.atoms[1].nucleus == "\u{00F7}")
    #expect(superList.atoms[2].type == .number)
    #expect(superList.atoms[2].nucleus == "2")
  }
  ...
  @Test func matrix() throws {
    let list = try #require(
      MTMathListBuilder(string: "\\begin{matrix} x & y \\\\ z & w \\end{matrix}").build())
    #expect(list.atoms.count == 1)
  ...
  @Test func pmatrix() throws {
    let list = try #require(
      MTMathListBuilder(string: "\\begin{pmatrix} x & y \\\\ z & w \\end{pmatrix}").build())
    #expect(list.atoms.count == 1)
    ...
    #expect(table.numColumns() == 2)
    #expect(
      MTMathListBuilder.mathList(toString: list)
  ...
  @Test func customSymbol() {
    ...
    MTMathAtomFactory.addLatexSymbol(
      "lcm", value: MTMathAtomFactory.operator(withName: "lcm", limits: false))
  ...
  @Test func fontOneChar() throws {
    ...
    #expect(list.atoms[0].type == .variable)
    #expect(list.atoms[0].nucleus == "x")
    #expect(list.atoms[0].fontStyle == .caligraphic)
    #expect(list.atoms[1].type == .variable)
    #expect(list.atoms[1].nucleus == "y")
  ...
  @Test func text() throws {
    ...
    #expect(list.atoms.count == 3)
    #expect(list.atoms[0].type == .variable)
    #expect(list.atoms[0].fontStyle == .roman)
    #expect(list.atoms[1].type == .ordinary)
    #expect(list.atoms[1].nucleus == " ")
    #expect(list.atoms[2].type == .variable)
    #expect(list.atoms[2].fontStyle == .roman)
  ...
  private func checkFractionVariant(
    ...
    let list = try #require(
      MTMathListBuilder(string: input).build(), sourceLocation: sourceLocation)
